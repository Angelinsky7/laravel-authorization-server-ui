...
var createModalImpl = function createModalImpl(modal_content, container) {
  ...
  container.append(modal); // Alpine.discoverUninitializedComponents((el) => {
  //     Alpine.initializeComponent(el)
  // }, container)
};

var closeModalImpl = function closeModalImpl(modalId) {
  ...
  document.addEventListener("click", function (e) {
    ...
    if (found) {
      ...
      if (link_href == null) {
        ...
        link_href = "".concat(el.action, "?").concat(search.toString());
      ...
      fetch(link_href).then(function (response) {
        return response.text();
      }).then(function (html) {
        return createModalImpl(html, modals);
      });
      return false;
    }
  });
...
/***/ "./resources/js/shared/table-select.js":
/*!*********************************************!*\
  !*** ./resources/js/shared/table-select.js ***!
  \*********************************************/
...
module.exports = function (itemsCount) {
  var setTickToInput = function setTickToInput(isChecked, root, selection) {
    root.querySelectorAll('input[data-select-input]').forEach(function (item) {
      item.checked = isChecked;

      if (isChecked) {
        selection.push(item.dataset.selectInput);
      }
    });
  };
  ...
  return {
    total: itemsCount,
    selection: [],
    reset: function reset(root, refs) {
      this.selection = [];
      setTickToInput(false, root, this.selection);
      refs.indeterminate = false;
      refs.checked = false;
    },
    toggle: function toggle(id, refs, isChecked) {
      if (id != null) {
    ...
    toggleAll: function toggleAll(isChecked, root) {
      this.selection = [];
...
/******/ 	__webpack_require__.O(undefined, ["public/css/policy"], () => (__webpack_require__("./resources/js/policy.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/policy"], () => (__webpack_require__("./resources/css/policy.css")))
