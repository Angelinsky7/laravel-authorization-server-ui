<x-app-layout>
    <x-slot name="header">
        <x-policy-ui-shared:default-header header="{{ __('Delete Permission') }} '{{ $item->name }}'" />
    </x-slot>
        ...
        <form method="POST" action="{{ route('policy-ui.permission.destroy', ['permission' => $item->id]) }}">
            ...
            <div class="flex flex-row">
                ...
                <x-policy-ui-shared:inner-modal-layout>
                    <x-policy-ui-shared:default-modal-title title="{{ _('Delete permission') }}" />
            ...
            <x-policy-ui-shared:default-modal-actions>
                <x-policy-ui-shared:link href="{{ route('policy-ui.permission.index') }}">{{ _('Cancel') }}</x-policy-ui-shared:link>
