                        ...
                        <x-policy-ui-shared:default-table-row>
                            ...
                            <x-policy-ui-shared:default-table-row-actions>
                                <x-policy-ui-shared:dropdown>¨
                                    ...
                                    <x-slot name="content">
                                        <x-policy-ui-shared:dropdown-link :href="route('policy-ui.resource.edit', ['resource' => $item->id])" content="{{ __('Edit') }}" />
                                        <x-policy-ui-shared:dropdown-link :href="route('policy-ui.resource.delete', ['resource' => $item->id])" data-remote data-modal content="{{ __('Delete') }}" />
                                    </x-slot>
                                </x-policy-ui-shared:dropdown>
                            </x-policy-ui-shared:default-table-row-actions>
                        </x-policy-ui-shared:default-table-row>
